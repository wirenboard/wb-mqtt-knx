...
class TMqttControlAdapterBuilderMock: public mqtt::IMqttDeviceAdapterBuilder
{
public:
...
public:
    MOCK_METHOD5(CreateControl, std::shared_ptr<mqtt::IMqttControlAdapter> (const std::string& id,
